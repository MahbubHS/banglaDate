...
{
	var d = Object.prototype.toString.call(inputDate) === '[object Date]' ? inputDate : new Date().toBdTime();
	this.inputDate = d;
	...
	if( d < new Date() && d > new Date(1970,0,1) ) // Additional code to respect convention before 1430 bengali year
	{
...
bdDateConverter.prototype.A = function(){
	if( this.dateInstance.G >= 4 && this.dateInstance.G < 6)
		return 0;
	else if (this.dateInstance.G >= 6 && this.dateInstance.G < 12)
	  return 1;
		...
		return 5;
	else if( this.dateInstance.G >= 0 && this.dateInstance.G <4)
		return 5;
